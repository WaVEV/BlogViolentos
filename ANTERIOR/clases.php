...
class MySQL{  
	...
	public function MySQL(){
		if(!isset($this->conexion)){  
			$this->conexion = (mysql_connect("localhost","blogsviolentos","tontita")) or die(mysql_error());  
			mysql_select_db("blogsviolentos",$this->conexion) or die(mysql_error());  
		}  
	}  
