...
$database_publica = "blogsviolentos";
$username_publica = "blogsviolentos";
...
$DirFotos="/var/www/vhosts/marcelo/apdb1.no-ip.info/httpdocs/blogsviolentos/imagenes/";
$URLFotos="http://apdb1.no-ip.info/blogsviolentos/imagenes/";
$DirectorioListos="/var/www/vhosts/marcelo/apdb1.no-ip.info/httpdocs/blogsviolentos/listos/";
$DirCache="/var/www/vhosts/marcelo/apdb1.no-ip.info/httpdocs/blogsviolentos/cache/";
...
class HttpRequest{
    ...
    public function CargaPagina( ){
        ...
        $CookiePath = realpath($GLOBALS['DirCache']."/cookie_".$azarcache.".txt");
